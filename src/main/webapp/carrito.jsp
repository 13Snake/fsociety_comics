                    ...
                    <ul class='list-group'>
                        <%
                            ...
                            if(session.getAttribute("carrito")!=null){
                                ...
                                out.println("<a class='btn btn-danger' href='carsave?opt=4"+"'>Vaciar el carrito</a>");
                                out.println("</div>");
                                for(infocarrito item : info_car){
                                    ...
                                    out.println("<a href='infoprod.jsp?id="+item.getIdprod()+"'><img width='80' height='100' src='assets/productos/prod_2.png' class='image-fluid'></a>");
                                    out.println("</div>");
                                    out.println("</div>");
